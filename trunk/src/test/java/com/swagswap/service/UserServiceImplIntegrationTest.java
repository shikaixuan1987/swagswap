...
public class UserServiceImplIntegrationTest extends LocalDatastoreTestCase  {
    ...
    public void testAddUserRating() {
    	...
    	swagSwapUserService.addUserRating(swagSwapUser, swagItem.getKey(), 1);
    	
    	SwagSwapUser user = swagSwapUserService.findByEmail(swagSwapUser.getEmail());
    	assertTrue(user.getRatedSwagItems().size()==1);
    }
